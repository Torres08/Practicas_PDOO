...
public class CasillaCalle extends Casilla{
    ...
    public float getImporteHacermeSostenible(){
        float importeExtra = getPrecioCompra()*calcularPorcentajeInversionPorSostenibilidad();
        return importeExtra;
    }
    
    public CasillaCalleSostenible hacermeSostenible(Jugador jugador){
        CasillaCalleSostenible convertida = new CasillaCalleSostenible(getNombre(), precioCompra, precioEdificar ,precioBaseAlquiler);
        convertida.setPorcentajeInversion(calcularPorcentajeInversionPorSostenibilidad());
        jugador.hacerCalleSostenible(jugador.getCasillaActual());
        return convertida;
    }
